...
copy /Y submissions\retryoos\incremental_sa.py "%CHALLENGE_REPO%\submissions\retryoos\incremental_sa.py" >nul
copy /Y submissions\retryoos\soft_overlap_sa.py "%CHALLENGE_REPO%\submissions\retryoos\soft_overlap_sa.py" >nul
copy /Y submissions\retryoos\replace_sa.py "%CHALLENGE_REPO%\submissions\retryoos\replace_sa.py" >nul
